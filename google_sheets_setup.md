...
function handleGetAllCustomersDetailed() {
  ...
  var result = dataRows.map(function(r) {
    ...
    return {
      ...
      lineAt: r["_col_11"] || r["Line@"] || r["LINE"] || r["Line @"] || "-",
      siteType: r["_col_37"] || r["_col_16"] || r["SiteType"] || r["ประเภทหน้างาน"] || r["สถานที่"] || "",
      installDate: r["InstallDate"] || r["วันที่ติดตั้ง"] || "",
      filmModel: r["_col_33"] || r["FilmModel"] || r["รุ่นฟิล์ม"] || r["รุ่นฟิล์ม / พื้นที่ติดตั้ง"] || "",
